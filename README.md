...
hulkbuster#v0.1
hulkbuster/v0.1
hulkbuster@v0.1  <- not work properly when pip parsing URI
hulkbuster_v0.1
$ pip install git+ssh://git@github.com/apua/mylib@6d16e3d4d14bf29ec88bfb6604f9c6df09b21709#subdirectory=hulkbuster
$ pip install git+ssh://git@github.com/apua/mylib@hulkbuster_v0.1#subdirectory=hulkbuster
$ pip install git+ssh://git@github.com/apua/mylib@hulkbuster#v0.1#subdirectory=hulkbuster
$ pip install git+ssh://git@github.com/apua/mylib@hulkbuster/v0.1#subdirectory=hulkbuster
```
